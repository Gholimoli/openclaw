...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list.*.systemPrompt": "Agent System Prompt",
  ...
  evolution: "Evolution",
  "evolution.enabled": "Evolution Enabled",
  "evolution.objective": "Evolution Objective",
  "evolution.cadence": "Evolution Cadence",
  "evolution.cadence.scout": "Evolution Scout Cadence",
  "evolution.cadence.synth": "Evolution Synthesis Cadence",
  "evolution.autonomy": "Evolution Autonomy",
  "evolution.autonomy.mode": "Evolution Autonomy Mode",
  "evolution.autonomy.mergeScope": "Evolution Merge Scope",
  "evolution.discovery": "Evolution Discovery",
  "evolution.discovery.mode": "Evolution Discovery Mode",
  "evolution.discovery.nominations": "Evolution Source Nominations",
  "evolution.sources.allowlist": "Evolution Source Allowlist",
  "evolution.sources.allowlist.*.id": "Evolution Source ID",
  "evolution.sources.allowlist.*.kind": "Evolution Source Kind",
  "evolution.sources.allowlist.*.enabled": "Evolution Source Enabled",
  "evolution.sources.allowlist.*.url": "Evolution Source URL",
  "evolution.sources.allowlist.*.githubOwner": "Evolution GitHub Owner",
  "evolution.sources.allowlist.*.githubRepo": "Evolution GitHub Repository",
  "evolution.sources.allowlist.*.include": "Evolution GitHub Include",
  "evolution.sources.allowlist.*.tags": "Evolution Source Tags",
  "evolution.sources.allowlist.*.reliabilityTier": "Evolution Source Reliability Tier",
  "evolution.x.mode": "Evolution X Mode",
  "evolution.x.browserFallback": "Evolution Browser Fallback",
  "evolution.execution.workTarget": "Evolution Work Target",
  "evolution.execution.mergePath": "Evolution Merge Path",
  "evolution.execution.maxConsecutiveFailures": "Evolution Max Consecutive Failures",
  "evolution.execution.maxFailuresPer24h": "Evolution Max Failures in 24h",
};
