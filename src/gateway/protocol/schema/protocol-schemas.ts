...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  AutomationActor: AutomationActorSchema,
  AutomationSpecPacket: AutomationSpecPacketSchema,
  AutomationRun: AutomationRunSchema,
  AutomationStep: AutomationStepSchema,
  AutomationAuditEntry: AutomationAuditEntrySchema,
  AutomationApprovalEvent: AutomationApprovalEventSchema,
  AutomationRunsListParams: AutomationRunsListParamsSchema,
  AutomationRunsListResult: AutomationRunsListResultSchema,
  AutomationRunsGetParams: AutomationRunsGetParamsSchema,
  AutomationRunsGetResult: AutomationRunsGetResultSchema,
  AutomationRunsResumeParams: AutomationRunsResumeParamsSchema,
  AutomationRunsResumeResult: AutomationRunsResumeResultSchema,
  AutomationRunsCancelParams: AutomationRunsCancelParamsSchema,
  AutomationRunsCancelResult: AutomationRunsCancelResultSchema,
  AutomationAuditQueryParams: AutomationAuditQueryParamsSchema,
  AutomationAuditQueryResult: AutomationAuditQueryResultSchema,
  ...
  EvolutionSourceSpec: EvolutionSourceSpecSchema,
  EvolutionSource: EvolutionSourceSchema,
  EvolutionInsight: EvolutionInsightSchema,
  EvolutionProposal: EvolutionProposalSchema,
  EvolutionStatusParams: EvolutionStatusParamsSchema,
  EvolutionStatus: EvolutionStatusSchema,
  EvolutionSourcesListParams: EvolutionSourcesListParamsSchema,
  EvolutionSourcesListResult: EvolutionSourcesListResultSchema,
  EvolutionSourcesUpsertParams: EvolutionSourcesUpsertParamsSchema,
  EvolutionInsightsListParams: EvolutionInsightsListParamsSchema,
  EvolutionInsightsListResult: EvolutionInsightsListResultSchema,
  EvolutionProposalsListParams: EvolutionProposalsListParamsSchema,
  EvolutionProposalsListResult: EvolutionProposalsListResultSchema,
  EvolutionProposalsActParams: EvolutionProposalsActParamsSchema,
  EvolutionProposalsActResult: EvolutionProposalsActResultSchema,
  OfficeAgentState: OfficeAgentStateSchema,
  OfficeActivityEntry: OfficeActivityEntrySchema,
  OfficeLayout: OfficeLayoutSchema,
  OfficeSnapshotParams: OfficeSnapshotParamsSchema,
  OfficeLayoutGetParams: OfficeLayoutGetParamsSchema,
  OfficeLayoutSetParams: OfficeLayoutSetParamsSchema,
  OfficeSnapshot: OfficeSnapshotSchema,
  ...
  ExecApprovalListRequest: ExecApprovalListRequestSchema,
  ExecApprovalListItem: ExecApprovalListItemSchema,
